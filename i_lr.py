...
# shhs_1 = shhs_1.sample(n=200,random_state=2)
# shhs_2 = shhs[shhs['S_AHI_2'] == 0]
# shhs_2 = shhs_2.sample(n=100,random_state=2)
...
def train_lgb(train, label):
    ...
    model = LogisticRegression(C=10,max_iter=7 )
    ...
    new_df.to_csv('train_proba_lr.csv')
    print("---AUC-proba---")
    ...
    new_df.to_csv('val_proba_lr.csv')
    ...
    new_df.to_csv('test_proba_lr.csv')
    print("---AUC-proba---")
    ...
    new_df.to_csv('shhs_proba_lr.csv')
